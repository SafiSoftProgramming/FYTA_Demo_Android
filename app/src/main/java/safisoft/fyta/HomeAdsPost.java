...
public class HomeAdsPost {
    ...
    public HomeAdsPost(int id, String ad_desc, String ad_img, String ad_name, String ad_icon, String ad_time_date, String promo_code, String promo_code_expiry_date, String contact_details) {
        this.id = id;
